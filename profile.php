					...
					?>
						<script>
							$(document).ready(function(){
								$('#user_gender').val("<?= $row["user_gender"]; ?>");
							});
						</script>
						...
						<div class="form-group">
							...
							<textarea name="user_address" id="user_address" class="form-control"><?= $row["user_address"]; ?></textarea>
						</div>
						<div class="form-group">
							<label>Enter Mobile Number</label>
							<input type="text" name="user_mobile_no" id="user_mobile_no" class="form-control" value="<?= $row["user_mobile_no"]; ?>" />
						</div>
						<div class="form-group">
							<label>Select Profile Image</label>
							<input type="file" name="user_image" id="user_image" accept="image/*" /><br />
							<img src="upload/<?= $row["user_image"]; ?>" class="img-thumbnail" width="250" />
