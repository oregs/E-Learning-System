...
<div class="row">
	...
	<div class="col-md-4">
		<br />
		<div align="center">
			<div id="exam_timer" data-timer="<?= $remaining_minutes; ?>" style="max-width:400px; width:100%; height:200px;"></div>
		</div>
		<br />
...
$(document).ready(function(){
 	...
 	$(document).on('blur', '.answer_option', function(){
 		var question_id = $(this).data('question_id');

 		if($(this).data('question_type') == 'Subjunctive')
 		{
 			var answer_option = $('#sub_answer').val();
 		}

 		if($(this).data('question_type') == 'Objective')
 		{
