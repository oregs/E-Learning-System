          ...
          <div class="card bg-secondary shadow border-0">
            <div class="card-header bg-white pb-5">
              <div class="btn-wrapper text-center">
                <h4><b>Tutor Login</b></h4>
              </div>
            </div>
            <div class="card-body px-lg-5 py-lg-5">
              <form method="post" id="tutor_login_form">
                <div class="form-group">
                  <label>Enter Email Address</label>
                  <input type="text" name="tutor_email_address" id="tutor_email_address" class="form-control" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group" align="center">
                  ...
                  <input type="submit" name="tutor_login" id="tutor_login" class="btn btn-primary my-4" value="Login">
                </div>
              </form>
            </div>
          </div>
...
$(document).ready(function(){
  $('#tutor_login_form').parsley();

  $('#tutor_login_form').on('submit', function(event){
    ...
    if($('#tutor_login_form').parsley().validate())
    {
      $.ajax({
        ...
        dataType:"json",
        beforesend:function(){
          $('#tutor_login').attr('disabled', 'disabled');
          $('#tutor_login').val('please wait..');
        },
        success:function(data)
        {
          if(data.success)
          {
            location.href="tutor_module.php";
          }
          else
          {
            $('#message').html('<div class="alert alert-danger">'+data.error+'</div>');
          }
          $('#tutor_login').attr('disabled', false);
          $('#tutor_login').val('Login');
        }
      });
    }
  });
