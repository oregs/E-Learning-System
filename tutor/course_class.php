      ...
      <table id="classroom_table" class="table table-bordered table-striped table-hover">
        ...
        <tbody>
              ...
              $sub_result = $exam->query_result();
	        		...
	        		{
                $student_view =  $exam->Get_total_row($sub_row['classroom_id']);
	        			echo '
	        			<tr>
                  <td><b>'.$sub_row["classroom_title"].'</b></td>
                  <td>'.$student_view.'</td>
                  <td><i>'.$sub_row['classroom_created_on'].'<i></td>
                  <td><a href="classroom.php?code='.$sub_row["classroom_code"].'" class="btn btn-info"><i class="fa fa-book"> Join Class</i></a></td>
	        			</tr>
	        			';
	        		}
        		?>
