    ...
    <form method="post" enctype="multipart/form-data" id="classroom_form">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <div class="row">
              <label class="col-md-2 text-right">From<span class="text-danger">*</span></label>
              <div class="col-md-10">
                <input type="text" name="from_datetime" id="from_datetime" class="form-control input-daterange" placeholder="From Datetime" readonly /><br/>
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="row">
              <label class="col-md-2 text-right">To<span class="text-danger">*</span></label>
              <div class="col-md-10">
                <input type="text" name="to_datetime" id="to_datetime" class="form-control input-daterange" placeholder="To Datetime" readonly /><br/>
              </div>
            </div>
          </div>
  ...
  $('#classroom_form').parsley();
    ...
    $('#classroom_form').on('submit', function(event){
      event.preventDefault();
        ...
        $('#from_datetime').attr('required', 'required');
        $('#to_datetime').attr('required', 'required');
  ...
  $(document).on('click', '.edit', function(){
    ...
    $.ajax({
      ...
      success:function(data)
      {
        ...
        $('#from_datetime').val(data.from_datetime); 
        $('#to_datetime').val(data.to_datetime); 
