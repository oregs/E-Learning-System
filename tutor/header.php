...
$tutor_image = $exam->Get_specific_data('tutor_table', 'tutor_id', $_SESSION['tutor_id'], 'tutor_image');
...
<head>
  ...
  <script src="../style/js/notify_me.js"></script>
...
<br>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="tutor_module.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
        <li><a href="assignment_details.php"><i class="fa fa-users"></i> <span>Assignment Module</span></a></li>
        <li><a href="assignment_result.php"><i class="fa fa-file-word-o"></i> <span>Assignment Results</span></a></li>
        <li><a href="grading.php"><i class="fa fa-users"></i> <span>Grading Module</span></a></li>
        <li><a href="classroom_details.php"><i class="fa fa-book"></i> <span>Classroom Plan</span></a></li>
        ...
        <li><a href="exam_result_details.php"><i class="fa fa-group"></i> <span>Examination Results</span></a></li>
        <li><a href="group.php"><i class="fa fa-users"></i> <span>Group Module</span></a></li>
        <li><a href="attendance.php"><i class="fa fa-check-square"></i> <span>Attendance Module</span></a></li>
